...
<template>
    <UPageCard class="mt-3" title="Tailwind CSS" >
         <UFormField  label="Name" :error="authStore.errors?.name?.find(() => true)">
        ...
        <UFormField label="Confirm Password">
            <UInput type="password" v-model="formData.password_confirmation" class="w-full" placeholder="Confirm Password" :error="authStore.errors?.password_confirmation?.find(() => true)" />
        </UFormField>
